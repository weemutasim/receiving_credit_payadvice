...
List<pw.Widget> headerReportIncomeA4Landscape(pw.Context context, String titleThai, String titleEng, DateTime date, pw.MemoryImage logoblack, pw.Font pgVim, pw.Font traJanPro, String name, String code, List<CashAdvance> adv, List<CashAdvance> credit) {
  ...
  return <pw.Widget>[
    pw.Row(
      ...
      children: [
        ...
        if(adv.isNotEmpty || credit.isNotEmpty) pw.Container(
          width: 400,
          height: 100,
            ...
            children: [
              ...
              pw.Row(
                ...
                children: [
                  ...
                  buildConCredit('PayType', pgVim, 55),
